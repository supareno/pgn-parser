...
public class PGNParser extends AbstractPGNParser {
   ...
   */
  public static final String SINGLE_HIT_STRING_PATTERN = "([a-hA-H]+[1-8]{1}[=][A-Z]{1}[\\+|#]?|"
      + // promotion
   ...
   */
  public static final Pattern ATTRIBUTES_PATTERN = Pattern
   ...
   */
  public static final Pattern HITS_PATTERN = Pattern
   ...
   */
  public static final Pattern NUMBER_VALIDITY_PATTERN = Pattern
   ...
   */
  public static final Pattern SINGLE_HIT_PATTERN = Pattern
      .compile(SINGLE_HIT_STRING_PATTERN);
  ...
  /**
   * Parses the {@code attributes} and the {@code hits} and returns a
   * {@code PGNGame} filled with the datas.
   * 

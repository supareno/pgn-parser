...
public abstract class AbstractPGNWriter extends AbstractPGNIO implements Writer {
	 ...
	 * creation added at the end. The format of the date is:
	 * <p>
	 * {@code yyyyMMddHHmmss}
	 * </p>
	...
	/**
	 * Formats a Date and returns it to a String representation using the {@link #DATEFORMAT}
	 * SimpleDateFormat pattern. A new Date is used at
	 * every call.
	 * 
	 * @return a String representation of a Date using the {@link #DATEFORMAT} SimpleDateFormat
	 *         pattern.
	 * 
	...
	/**
	 * Formats a Date and returns it to a String representation using the {@code sdf} SimpleDateFormat
	 * pattern. A new Date is used at
	 * every call.
	 * 

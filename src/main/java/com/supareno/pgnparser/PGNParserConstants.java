...
public final class PGNParserConstants {
	...
	// SEVEN ROSTER TAGS
	/** 
	 * The {@code EVENT_ATTR} String represents the <i>event</i> key: 
	 * this value is set to {@code Event}. 
	 */
	public static final String EVENT_ATTR = "Event";

	/** 
	 * The {@code SITE_ATTR} String represents the <i>site</i> key: 
	 * this value is set to {@code Site}. 
	 */
	public static final String SITE_ATTR = "Site";

	/** 
	 * The {@code DATE_ATTR} String represents the <i>date</i> key: 
	 * this value is set to {@code Date}. 
	 */
	public static final String DATE_ATTR = "Date";

	/** 
	 * The {@code ROUND_ATTR} String represents the <i>round</i> key: 
	 * this value is set to {@code Round}. 
	 */
	public static final String ROUND_ATTR = "Round";

	/** 
	 * The {@code WHITE_ATTR} String represents the <i>white</i> key: 
	 * this value is set to {@code White}. 
	 */
	public static final String WHITE_ATTR = "White";

	/** 
	 * The {@code BLACK_ATTR} String represents the <i>black</i> key: 
	 * this value is set to {@code Black}. 
	 */
	public static final String BLACK_ATTR = "Black";

	/** 
	 * The {@code RESULT_ATTR} String represents the <i>result</i> key: 
	 * this value is set to {@code Result}. 
	 */
	...
	/** 
	 * The {@code WHITE_ELO_ATTR} String represents the <i>white elo</i> key: 
	 * this value is set to {@code WhiteElo}. 
	 */
	...
	/** 
	 * The {@code WHITE_NA_ATTR} String represents the <i>white NA</i> key: 
	 * this value is set to {@code WhiteNA}. 
	 */
	...
	/** 
	 * The {@code BLACK_ELO_ATTR} String represents the <i>black elo</i> key: 
	 * this value is set to {@code BlackElo}. 
	 */
	...
	/** 
	 * The {@code BLACK_NA_ATTR} String represents the <i>black NA</i> key: 
	 * this value is set to {@code BlackNA}. 
	 */
	...
	/** 
	 * The {@code EVENT_SPONSOR_ATTR} String represents the <i>event sponsor</i> key: 
	 * this value is set to {@code EventSponsor}. 
	 */
	public static final String EVENT_SPONSOR_ATTR = "EventSponsor";

	/** 
	 * The {@code SECTION_ATTR} String represents the <i>section</i> key: 
	 * this value is set to {@code Section}. 
	 */
	public static final String SECTION_ATTR = "Section";

	/** 
	 * The {@code STAGE_ATTR} String represents the <i>stage</i> key: 
	 * this value is set to {@code Stage}. 
	 */
	public static final String STAGE_ATTR = "Stage";

	/** 
	 * The {@code BOARD_ATTR} String represents the <i>board</i> key: 
	 * this value is set to {@code Board}. 
	 */
	public static final String BOARD_ATTR = "Board";

	/** 
	 * The {@code OPENING_ATTR} String represents the <i>opening</i> key: 
	 * this value is set to {@code Opening}. 
	 */
	public static final String OPENING_ATTR = "Opening";

	/** 
	 * The {@code VARIATION_ATTR} String represents the <i>variation</i> key: 
	 * this value is set to {@code WhiteElo}. 
	 */
	public static final String VARIATION_ATTR = "Variation";

	/** 
	 * The {@code SUBVARIATION_ATTR} String represents the <i>sub variation</i> key: 
	 * this value is set to {@code SubVariation}. 
	 */
	public static final String SUBVARIATION_ATTR = "SubVariation";

	/** 
	 * The {@code NIC_ATTR} String represents the <i>nic</i> key: 
	 * this value is set to {@code Nic}. 
	 */
	public static final String NIC_ATTR = "Nic";

	/** 
	 * The {@code TIME_ATTR} String represents the <i>time</i> key: 
	 * this value is set to {@code Time}. 
	 */
	public static final String TIME_ATTR = "Time";

	/** 
	 * The {@code UTCTIME_ATTR} String represents the <i>UTC time</i> key: 
	 * this value is set to {@code UTCTime}. 
	 */
	public static final String UTCTIME_ATTR = "UTCTime";

	/** 
	 * The {@code UTCDATE_ATTR} String represents the <i>UTC date</i> key: 
	 * this value is set to {@code UTCDate}. 
	 */
	public static final String UTCDATE_ATTR = "UTCDate";

	/** 
	 * The {@code TIME_CONTROL_ATTR} String represents the <i>time control</i> key: 
	 * this value is set to {@code TimeControl}. 
	 */
	public static final String TIME_CONTROL_ATTR = "TimeControl";

	/** 
	 * The {@code SETUP_ATTR} String represents the <i>set up</i> key: 
	 * this value is set to {@code SetUp}. 
	 */
	public static final String SETUP_ATTR = "SetUp";

	/** 
	 * The {@code FEN_ATTR} String represents the <i>FEN</i> key: 
	 * this value is set to {@code FEN}. 
	 */
	...
	/** 
	 * The {@code ECO_ATTR} String represents the <i>eco</i> key: 
	 * this value is set to {@code Eco}. 
	 */

...
public final class JUnitTestConstants {
     ...
     */
    static final public String XML_PGN_FILE = "src/main/resources/xml/testFile_3.0.xml";

    /**
     * json test file: this file contains the same game as the testFile.pgn file
     */
    public static final String JSON_PGN_FILE = "src/main/resources/json/testFile_3.0.json";
    /**
     * json test file: this file contains the same game as the testFile.pgn file
     */
    public static final String JSON_2_GAMES_PGN_FILE = "src/main/resources/json/testFile_jsonArray_3.0.json";
    ...
    static {
        ...
        REFERENCE_GAME_2_2.getHits().add(hit);
        hit = new Hit();
        hit.setNumber("2");
